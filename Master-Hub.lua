...
--return args
 return old(...)
	...
	--// Fast Attack
	local AttackList = {"Chậm", "Thường", "Siêu nhanh"}
	_G.FastAttackDelay = "Thường"
	AttackList = true
	spawn(function()
	    while wait(.1) do
	        if _G.FastAttackDelay then
	            pcall(function()
	                if _G.FastAttackDelay == "Chậm" then
	                    _G.FastAttackDelay = 0.2
	                elseif _G.FastAttackDelay == "Default" then
	                    _G.FastAttackDelay = 0.5
	                elseif _G.FastAttackDelay == "Thường" then
	                    _G.FastAttackDelay = 0.2
...
ImageButton.Image = "rbxassetid://16227553843"
...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "Nhận Cày Thuê Bán Acc v4 Ae Nào Cần IB" , 6 ,16227553843 )
	DiscordLib:Notification("Thông Báo" , "Link Facebook Ở Phần Setting" , 6 ,16227553843 )
 ...
 local uihide = false
 local abc = false
 local logo = logo or 16227553843
 local currentpage = ""
...
function CheckQuest() 
    ...
    if World1 then
		...
		elseif MyLevel == 150 or MyLevel <= 174 or _G.Select_Mob_Farm == "Sky Bandit [Lv. 150]" then -- Sky Bandit
			...
			SPAWNPOINT = "Sky"
		elseif MyLevel == 175 or MyLevel <= 189 or _G.Select_Mob_Farm == "Dark [Lv. 175]" then -- Dark Master
			Ms = "Dark Mạnh Hero Hub[Lv. 175]"
			NameQuest = "SkyQuest"
			LevelQuest = 2
			NameMon = "Dark Master"
			CFrameQuest = CFrame.new(-4841.83447, 717.669617, -2623.96436, -0.875942111, 5.59710216e-08, -0.482416272, 3.04023082e-08, 1, 6.08195947e-08, 0.482416272, 3.86078725e-08, -0.875942111)
...
function checkselect() 
    ...
    if World1 then
		...
		elseif MyLevel == 150 or MyLevel <= 174 or SelectMonster == "Sky Bandit [Lv. 150]" then -- Sky Bandit
			...
			CFrameMon = CFrame.new(-4970.74219, 294.544342, -2890.11353, -0.994874597, -8.61311236e-08, -0.101116329, -9.10836206e-08, 1, 4.43614923e-08, 0.101116329, 5.33441664e-08, -0.994874597)
			--Spawn = "Sky"
		elseif MyLevel == 175 or MyLevel <= 189 or SelectMonster == "Dark Mạnh Hero Hub[Lv. 175]" then -- Dark Master
			Mon = "Dark Mạnh Hero Hub[Lv. 175]"
			--NameQuest = "SkyQuest"
			LevelQuest = 2
			NameMon = "Dark Master"
			--CFrameQuest = CFrame.new(-4841.83447, 717.669617, -2623.96436, -0.875942111, 5.59710216e-08, -0.482416272, 3.04023082e-08, 1, 6.08195947e-08, 0.482416272, 3.86078725e-08, -0.875942111)
...
Setting:Button("Sao Chép Link Facebook",function()
 ...
 setclipboard("https://www.facebook.com/profile.php?id=100082762635480&mibextid=ZbWKwL")
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=16227553843"
ImageLabel.ScaleType = Enum.ScaleType.Fit
