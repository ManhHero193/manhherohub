if getgenv().ManhHero then 
	if game.CoreGui:FindFirstChild("ManhHero Hub GUI") then
		for i, v in ipairs(game.CoreGui:GetChildren()) do
			if string.find(v.Name,  "ManhHero Hub") then
				v:Destroy()
			end
		end
	end
end
getgenv().ManhHero = true
...
local T1UIColor = {
	...
	["Logo Image"] = "rbxassetid://16227553843",
...
Library_Function.Gui.Name = 'ManhHero Hub GUI'
...
Library.ToggleUI = function()
	...
	if game.CoreGui:FindFirstChild("ManhHero Hub GUI") then
		for a, b in ipairs(game.CoreGui:GetChildren()) do
			if b.Name == "ManhHero Hub GUI" then
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,206,27") .. ")\">" .. tostring("ManhHero Hub") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Title or "ManhHero Hub"
	...
	local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
    TextLabelMain.Text = "<font color=\"rgb(" .. tostring(color or "255,206,27") .. ")\">" .. tostring(TitleNameMain or "ManhHero Hub") .. "</font> " .. tostring(getgenv().MainDesc or "")
